	...
	<div id="header" class="container">
		<div id="menu">
			<ul>
				...
				<li><a href="servicos.jsp" accesskey="2" title="">Serviços</a></li>
				...
				<li><a href="orcamento.jsp" accesskey="5" title="">Fazer Orçamento</a></li>
				<li><a href="#usuario" accesskey="5" title=""> 
				<%         
